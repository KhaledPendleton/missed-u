defmodule MissedUWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MissedUWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MissedUWeb.Gettext, "errors", msg, opts)
    end
  end
